...
/**
 * Get the 'foxbpm:collection' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'foxbpm:collection' value
 */
function getCollection(element) {
  return getProperty(element, 'foxbpm:collection');
}

/**
 * Get the 'foxbpm:elementVariable' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'foxbpm:elementVariable' value
 */
function getElementVariable(element) {
  return getProperty(element, 'foxbpm:elementVariable');
}
...
module.exports = function(element, bpmnFactory) {
  ...
  entries.push(entryFactory.textField({
    ...
    set: function(element, values) {
      ...
      return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
        'foxbpm:collection': values.collection || undefined
      });
    },
  ...
  entries.push(entryFactory.textField({
    ...
    set: function(element, values) {
      var loopCharacteristics = getLoopCharacteristics(element);
      return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
        'foxbpm:elementVariable': values.elementVariable || undefined
      });
    }
  }));
