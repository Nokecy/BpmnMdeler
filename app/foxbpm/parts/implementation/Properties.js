...
/**
 * Get all foxbpm:property objects for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {Array<ModdleElement>} a list of foxbpm:property objects
 */
...
/**
 * Get all foxbpm:Properties object for a specific business object
 *
 * @param  {ModdleElement} parent
 *
 * @return {ModdleElement} a foxbpm:Properties object
 */
...
/**
 * Get first foxbpm:Properties object for a specific bpmn:ExtensionElements
 * business object.
 *
...
function getPropertiesElementInsideExtensionElements(extensionElements) {
  return find(extensionElements.values, function(elem) {
    return is(elem, 'foxbpm:Properties');
  });
}
...
/**
 * Create a foxbpm:property entry using tableEntryFactory
 *
...
module.exports = function(element, bpmnFactory, options) {
  ...
  assign(options, {
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('foxbpm:Properties', {}, parent, bpmnFactory);
      ...
      var property = elementHelper.createElement('foxbpm:Property', propertyProps, properties, bpmnFactory);
