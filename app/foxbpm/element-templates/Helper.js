...
var TEMPLATE_ATTR = 'foxbpm:modelerTemplate';
...
function findCamundaInOut(element, binding) {
  ...
  if (binding.type === 'foxbpm:in') {
    matcher = function(e) {
      return is(e, 'foxbpm:In') && isInOut(e, binding);
    };
  } else
  if (binding.type === 'foxbpm:out') {
    matcher = function(e) {
      return is(e, 'foxbpm:Out') && isInOut(e, binding);
    };
  } else
  if (binding.type === 'foxbpm:in:businessKey') {
    matcher = function(e) {
      return is(e, 'foxbpm:In') && 'businessKey' in e;
    };
  }
